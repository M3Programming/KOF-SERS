 ...
 * @author MJ
 */
public class EmailForm1 extends javax.swing.JFrame {
    ...
    private void btn_sendActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_sendActionPerformed
            ...
            lbl_message.setText("Please check your Email for OTP");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EmailForm1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new EmailForm1().setVisible(true);
        });
    }
